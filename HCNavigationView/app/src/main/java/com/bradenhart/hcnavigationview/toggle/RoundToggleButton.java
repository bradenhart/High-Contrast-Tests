package com.bradenhart.hcnavigationview.toggle;

/**
 * Created by bradenhart on 28/06/15.
 */
...
public class RoundToggleButton extends RelativeLayout implements View.OnClickListener {
    ...
    public RoundToggleButton(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(R.layout.round_toggle, this, true);
        ...
        if (bgDrawableOff != null) {
            ...
            background_oval_off.setBackgroundResource(id);
        }
        if (bgDrawableOn != null) {
            ...
            background_oval_on.setBackgroundResource(id);
        }

        layout.setOnClickListener(this);

        //get a pixel size for a particular dimension - will differ by device according to screen density
        dimen = getResources().getDimensionPixelSize(R.dimen.shift_distance);
